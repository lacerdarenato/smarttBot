Projeto inspirado no projeto publicado no repositório [here](https://github.com/coder787/coin-finder)
alterações feitas utilização com a api atravéz da requisição dos seu método publico: [here](https://poloniex.com/public?command=returnTicker)
...
![ScreenShot](https://github.com/coder787/coin-finder/blob/master/src/img/coin-finder-screenshot.JPG)
